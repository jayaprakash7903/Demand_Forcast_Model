...
if univariant_file and multivariant_file and raw_material_file and input_file:
    ...
    abc_results_df_A = abc_results_df[abc_results_df['ABC'] == 'A']
    grouped_df_A = abc_results_df_A.groupby('Name').agg({
        'quantity': 'sum',
        'price': 'mean',
        'total': 'sum',
    ...
    st.write("### Univariant Forecast and ABC Analysis (Category A)")
    st.write(grouped_df_A)
